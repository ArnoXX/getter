...
public class ExplorerRecycler extends RecyclerView {
    public ExplorerRecycler(@NonNull Context context) {
        super(context);
    }

    public static class ExplorerPagerAdapter extends PagerAdapter {
